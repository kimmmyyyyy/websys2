                            ...
                            <td class="whitespace-nowrap px-6 py-5 text-sm text-gray-600">
                                <div>
                                    <p class="font-medium text-gray-800">
                                        <?php echo e($log->created_at->setTimezone('Asia/Manila')->format('M d, Y')); ?>

                                    </p>

                                    <p class="text-xs text-gray-500">
                                        <?php echo e($log->created_at->setTimezone('Asia/Manila')->format('h:i A')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\websys2\library-management-system - (maayos copy 1)\resources\views/admin/reports/activity.blade.php ENDPATH**/ ?>