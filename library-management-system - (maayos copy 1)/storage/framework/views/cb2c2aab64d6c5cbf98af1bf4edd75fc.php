...
<div>
    ...
    <p class="mt-2 text-lg text-slate-600">
        <?php echo e($borrower->user->phone ?? 'Not provided'); ?>
...
<div>
    ...
    <p class="mt-2 text-lg text-slate-600">
        <?php echo e($borrower->user->address ?? 'Not provided'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\websys2\library-management-system - (maayos copy 1)\resources\views/user/profile.blade.php ENDPATH**/ ?>