...
<span class="font-semibold text-cyan-600">
    <?php if(request('all') || !request('date')): ?>
        All dates
    <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\websys2\library-management-system - (maayos copy 1)\resources\views/admin/reports/borrowing.blade.php ENDPATH**/ ?>