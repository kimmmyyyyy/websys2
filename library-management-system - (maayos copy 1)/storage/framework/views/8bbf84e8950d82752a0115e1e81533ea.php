        ...
        <div>
            ...
            <p class="mt-2 text-slate-500">
                ...
                <span class="font-semibold text-cyan-600">
                    <?php if(request('date')): ?>
                        <?php echo e(\Carbon\Carbon::parse(request('date'))->format('F d, Y')); ?>
...
<div class="text-xs text-slate-400">
    <?php if(!empty($transaction->borrow_time)): ?>
        <?php echo e(\Carbon\Carbon::parse($transaction->borrow_time, 'Asia/Manila')->format('h:i A')); ?>
...
<td class="px-8 py-5 text-slate-600">
    <div class="font-medium text-slate-900">
        <?php echo e($transaction->due_date ? \Carbon\Carbon::parse($transaction->due_date, 'Asia/Manila')->format('M d, Y') : ''); ?>

    </div>
    <div class="text-xs text-slate-400">
        <?php echo e($transaction->due_date ? \Carbon\Carbon::parse($transaction->due_date, 'Asia/Manila')->format('h:i A') : ''); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\websys2\library-management-system - (maayos copy 1)\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>