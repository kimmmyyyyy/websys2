                ...
                <nav class="flex flex-wrap items-center gap-2 text-sm font-medium text-slate-700">
                    ...
                    <?php if(auth()->user()->isAdmin()): ?>
                        ...
                        <a href="<?php echo e(route('admin.dashboard')); ?>"
                           class="rounded-full px-4 py-2 transition hover:bg-slate-100">
                            Dashboard
                        </a>
...
</html><?php /**PATH C:\xampp1\htdocs\websys2\library-management-system - (maayos copy)\resources\views/layouts/app.blade.php ENDPATH**/ ?>