...
<div class="space-y-6">
    ...
    <div class="rounded-lg bg-blue-50 p-8 border-2 border-blue-200 max-w-lg mx-auto text-center">
        ...
        <p class="text-blue-800 mb-6">
            You are logged in as <strong>{{ Auth::user()->name }}</strong>, but you haven't been registered as a borrower yet.
        </p>
        ...
        <a href="{{ route('home') }}" class="inline-block bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded font-medium">
            Go Home
        </a>
    </div>
</div>
